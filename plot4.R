...
#subset and convert "?" into NA values
...
#plot the graphs (4 in total)
par(mfrow=c(2,2))
#first graph
plot(y=data$Global_active_power, x=data$date.and.time, type = "l", xlab="", ylab = "Global Active Power")

#second graph
plot(y=data$Voltage, x=data$date.and.time, type = "l", xlab="datetime", ylab = "Voltage")
...
#fourth graph
plot(y=data$Global_reactive_power, x =data$date.and.time, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
